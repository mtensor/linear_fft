...
call("python run_odyssey_array.py -cmd run_fouriernetwork_odyssey.py -expt %d -cores 8 -hours 20 -mem 24000 -partition serial_reque -paramfile %s" % (expt,param_fn), shell=True)
