...
fo.write("#SBATCH --output=/n/home09/mnye/linear_fft/odyssey/results/fouriernetwork/expt%d/logs/%s.out\n" % (settings.expt, jobname))
fo.write("#SBATCH --error=/n/home09/mnye/linear_fft/odyssey/results/fouriernetwork/expt%d/logs/%s.err\n" % (settings.expt,jobname))
